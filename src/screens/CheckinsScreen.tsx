    ...
    <div className="flex flex-col gap-4">
      <section className="rounded-lg border border-border bg-card p-6 shadow-[var(--shadow)]">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
          <h3 className="text-lg font-semibold text-card-foreground">{t('checkin.head')}</h3>
        ...
        <button
          type="button"
          onClick={onSubmit}
          className="mt-4 h-11 w-full rounded-md bg-primary text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90"
        >
          {t('checkin.submit')}
        </button>
      </section>
      ...
      {summary?.ok && (
        <section className="rounded-lg border border-brand-500 bg-card p-6 shadow-[var(--shadow)]">
